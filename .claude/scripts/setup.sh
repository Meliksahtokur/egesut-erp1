...
[ "$missing_agents" -eq 0 ] && ok "Agents mevcut (10/10): gwen · gwen-reviewer · gwen-architect · gwen-researcher · gwen-analyst · gwen-coder · gwen-tester · gwen-telemetry · gwen-performance · gwen-orchestrator" || warn "Agent eksik ($found_agents/10)"
