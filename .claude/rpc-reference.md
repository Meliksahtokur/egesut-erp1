# RPC Quick Reference — Canlı Şemadan Regenerasyon (2026-09-01)

> **Kaynak (tek girdi):** `.claude/schema-snapshots/2026-08-31-live-schema-imzalar.md` — PROD Supabase,
...
→ Küpe çakışma kontrolü. Çağrı: forms.js:41.
...
**`asistan_hayvan_detay(p_kupe?, p_id?)`** → jsonb — hayvan 360° özeti.
