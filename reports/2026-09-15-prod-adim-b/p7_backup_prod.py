#!/usr/bin/env python3
"""P7 — PROD mantıksal yedek (Mgmt API, yazma YOK). P2 backup_prod.py uyarlaması.

Zarf (P4 §1): P2'nin yedek betiği, OUT değiştirilmiş:
  /home/melik/tmp/agents/prod-yedek-2026-09-15-adim-b/   (yeni klasör; mevcut
...
OUT = pathlib.Path("/home/melik/tmp/agents/prod-yedek-2026-09-15-adim-b")
...
meta = {"started": datetime.datetime.now().astimezone().isoformat(), "prod_ref": PROD_REF,
        "purpose": "P7 adim-b - 20260913000001 oncesi yedek (8 dosya: L2 20260913000001..04, L4 20260914000001..04)",
