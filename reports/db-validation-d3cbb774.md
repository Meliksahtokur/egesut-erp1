# DB Validation Raporu — d3cbb774

- Tarih: 2026-09-25 18:06:52+0300
...
- SHA-256: `d3cbb77461c14f86959d11db7bea2af2cb2f4135d8dd9bbe131f95b75880b660`
...
L:  86 | P:   1 | LT02 | Line should not be indented. [layout.indent]
L:  87 | P:   1 | LT02 | Line should not be indented. [layout.indent]
L:  93 | P:   1 | LT02 | Expected indent of 4 spaces. [layout.indent]
L:  94 | P:   1 | LT02 | Expected indent of 4 spaces. [layout.indent]
L:  95 | P:   1 | LT02 | Expected indent of 4 spaces. [layout.indent]
L:  95 | P:  39 | LT02 | Expected line break and no indent before ')'.
                       | [layout.indent]
L: 217 | P:  62 | CP02 | Unquoted identifiers must be consistently lower case.
                       | [capitalisation.identifiers]
L: 218 | P:   1 | LT05 | Line is too long (83 > 80). [layout.long_lines]
L: 218 | P:  71 | CP02 | Unquoted identifiers must be consistently lower case.
                       | [capitalisation.identifiers]
L: 219 | P:  64 | CP02 | Unquoted identifiers must be consistently lower case.
                       | [capitalisation.identifiers]
All Finished!
```
...
CREATE FUNCTION
CREATE FUNCTION
psql:/home/melik/.herdr/worktrees/egesut-erp1/ovysch-feature-cila-turu/supabase/migrations/20260925000018_kisir_ovsync_hardblock.sql:84: NOTICE:  trigger "trg_cases_kisir_ovsync" for relation "public.cases" does not exist, skipping
DROP TRIGGER
CREATE TRIGGER
CREATE FUNCTION
REVOKE
