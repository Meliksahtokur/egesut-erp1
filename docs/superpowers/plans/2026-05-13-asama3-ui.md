...
registerActions({
  ...
  // ═══ mClose PATTERN (event delegation'dan gelen event ile) ═══
  // HTML: <div class="modal" data-action="mclose" data-action-event="click">
  // NOT: mClose için data-action-event="click" kullan (click listener'ı yakalasın)
  // data-action olmayan mClose'lar için direkt data-action="mclose-overlay":
  ...
  // ═══ STOK PANELİ ═══
  'stok-tab-tumu':    () => setStokTab('tumu'),
  'stok-tab-ilac':    () => setStokTab('ilac'),
  'stok-tab-asi':     () => setStokTab('asi'),
  'stok-tab-sperma':  () => setStokTab('sperma'),
  'stok-tab-diger':   () => setStokTab('diger'),
