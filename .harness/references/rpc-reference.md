...
→ Doğum + buzağı kaydı + **ikiz olay modeli** (olay_id, 10g pencere, 60g anne guard; 2026-09-01 ikiz deploy). Görev sayısı: anne yan-etki 8 + buzağı 7 = 15 (yakın doğum varsa anne ayağı atlanır → 7). **20260906000001 ile (canlıda, deploy 2026-09-06)** d53'te tek `'53. Gün: E Vitamini'` (E_VIT) görevi üretilir (d53 Ademin + d54 Yeldif kaldırıldı; canlı doğrulama: pg_proc gövde imzaları + açık görev sayımları, 2026-09-06).
