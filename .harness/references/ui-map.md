...
| `js/gecmis.js` (`_gmEntriesFromSources`, `_gmGroupHtml`, `_gmCsv`, `_gmUndoRef`) | Shared history pipeline (main tab + animal-card, day groups, CSV, guarded undo) feeding `loadGecmis`/`_detRenderGecmis` |
