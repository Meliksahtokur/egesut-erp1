-- Migration: geri_al audit trail + gorev orphan fix + zincir + delete_treatment_day stok fix
-- Değişiklikler:
--   1. geri_al: DELETE → iptal=true (audit), VAKA_ACILDI'da TEDAVI_GUN gorevler siliniyor
--   2. add_treatment_day: parent_id ile zincir bağlantısı
--   3. delete_treatment_day: pozitif "iade" bug → iptal=true

-- ─────────────────────────────────────────────────────────────
-- 1. geri_al RPC — stok iptal=true, VAKA_ACILDI gorev orphan fix
-- ─────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────
-- 2. add_treatment_day — parent_id ile zincir (day N → day N-1)
-- ─────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────
-- 3. delete_treatment_day — stok bug fix: pozitif iade → iptal=true
-- ─────────────────────────────────────────────────────────────
