...
CREATE TABLE IF NOT EXISTS public.dogum (
  ...
  dogum_kg numeric,
  baba_bilgi text,
  olay_id uuid DEFAULT gen_random_uuid(),
...
-- ── grup/padok DB invariant'i (2026-07-17) — canlıdan append ──

-- FUNCTION: fn_hayvan_grup_padok_sync
...
CREATE TRIGGER trg_hayvan_grup_padok_sync BEFORE INSERT OR UPDATE OF grup, padok, padok_id ON public.hayvanlar FOR EACH ROW EXECUTE FUNCTION fn_hayvan_grup_padok_sync();
