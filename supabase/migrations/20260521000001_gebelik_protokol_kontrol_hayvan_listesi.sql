-- Migration: gebelik_protokol_kontrol — hayvan listesi döndür
-- Etkiler: gebelik_protokol_kontrol() REPLACE
--   + RETURN'e 'hayvanlar' eklendi: dashboard için 210+ gün gebe listesi
-- Geri alınabilir: DROP FUNCTION public.gebelik_protokol_kontrol();
--   restore: migrate 20260519000001'deki versiyon
