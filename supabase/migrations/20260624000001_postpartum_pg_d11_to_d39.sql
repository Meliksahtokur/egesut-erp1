-- Migration: Postpartum PG protokolü — 11. gün dozu → 39. gün (Presynch-14)
-- Gerekçe: 11. gün PG'si "sağır doz" (CL yok, luteoliz hedefi yok). Kanıt denetimi
--   (research/pgf-protocol-2026-06-24/) → d11 CONTRADICTED, d39 SUPPORTED (Presynch-14,
--   +7-10 pp P/AI, Moreira 2001 vd.). d2 dozu kullanıcı kararıyla KORUNDU.
-- Etki: protokol_eksik_tara() DOĞUM_PROTOKOL VALUES listesinde tek satır değişir.
--   (11, 'PG', '11. Gün PG')  →  (39, 'PG', '39. Gün PG (Presynch-14 senkron)')
-- Gövde 20260603000005_protokol_fix_v2.sql ile birebir aynıdır; sadece o satır farklı.
-- NOT: 0-70 gün tarama penceresi 39. günü kapsar, ek değişiklik gerekmez.
