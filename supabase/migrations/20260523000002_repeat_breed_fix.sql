-- Migration: Repeat breed fix — 15 gün penceresi kaldırıldı, deneme_no bazlı
-- Sorun: 15 günlük pencere dar, 2 aya yayılan tohumlamaları yakalamıyor
-- Çözüm: son_tohumlama'ya toh_deneme_no eklendi, max_deneme_no ile karşılaştırma
-- Geri al: DROP VIEW + önceki versiyonu geri yükle
...
SELECT
  ...
  -- deneme_no bazlı repeat breed tespiti (15 gün penceresi YOK)
