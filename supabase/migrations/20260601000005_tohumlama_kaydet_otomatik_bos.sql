-- Fix: tohumlama_kaydet — yeni tohumlama girildiğinde önceki Bekliyor kayıtlarını otomatik Boş yap
-- Kullanıcı bildirdi: yeni tohumlama girince eski Bekliyor hala Bekliyor görünüyor.
-- Bu migration tohumlama_kaydet RPC'sine UPDATE ekleyerek eski kayıtları Boş yapar.
...
BEGIN
  ...
  -- Önceki Bekliyor kayıtlarını Boş yap (yeni cycle başlıyor)
