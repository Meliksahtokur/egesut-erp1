-- Migration: v_eligible.sessiz_gun sinyal düzeltmesi
-- Tarih: 2026-06-25
-- Amaç: sessiz_gun = son_aktivite → son_dogum → dogum_tarihi → NULL.
--       Hiç sinyal yoksa NULL (9999 hilesi kalkar). Row-set DEĞİŞMEZ.
-- Spec: docs/superpowers/specs/2026-06-25-sessiz-hayvan-event-driven-uzlastirma-design.md §4
