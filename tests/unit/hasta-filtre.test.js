...
const { sandbox, document: docStub } = loadBrowserModule('js/ui.js', {
  // suttenKesimeHazirSec: T1 ile _dashStatRow'a girdi (helpers.js) — sandbox'a gerçek hali enjekte
  extra: { esc: escMirror, escAttr: escAttrMirror, getState: k => k === 'gebeIds' ? new Set() : undefined,
           suttenKesimeHazirSec: require('../../js/utils/helpers.js').suttenKesimeHazirSec },
});
