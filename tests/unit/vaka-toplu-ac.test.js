...
describe('V2.3 (W18) — 📂 Şablon Yükle kablolaması + ?v= damgası (manifest-içi metin denetimi)', () => {
  ...
  it('index.html: 📂 çipi + yükle alanı tek örnekte; her yerel script ?v=20260925-05 damgalı', () => {
    ...
    const damgasiz = yerel.filter(s => !/\?v=20260925-05$/.test(s));
